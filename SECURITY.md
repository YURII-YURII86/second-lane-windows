...
Secondary LANE может давать ChatGPT доступ к реальным действиям на машине, поэтому безопасность тут критична.
...
- Telegram: https://t.me/yurii_yurii86 (приватное сообщение)
- GitHub: используй Security Advisories на странице репозитория
...
Secondary LANE can expose real machine actions through ChatGPT and GPT Actions, so security matters.
...
- Telegram: https://t.me/yurii_yurii86 (direct message)
- GitHub: use Security Advisories on the repository page
